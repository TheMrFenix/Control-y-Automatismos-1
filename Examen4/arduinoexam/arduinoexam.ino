//Grupo los panas 
// ************ DEFINITIONS************
float kp = 0.02;    //Coeficiente Proporcional
float ki = 0.00015 ; //Coeficiente Integral 
float kd = 0; //Coeficiente Derivativo

unsigned long t;  //Tiempo
unsigned long t_prev = 0;  //Tiempo Previo

const byte interruptPinA = 2; //Pin introduciende valor 2 
const byte interruptPinB = 3; //Pin introduciendo valor 3
volatile long EncoderCount = 0; //Es para contar los giros del motor
const byte PWMPin = 6;
